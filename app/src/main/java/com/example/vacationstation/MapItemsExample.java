...
public class MapItemsExample {
    ...
    public void showCenteredMapMarkers() {
        ...
        addPhotoMapMarker(geoCoordinates);
        addPhotoMapMarker(new GeoCoordinates(48.185798, 16.400408), R.drawable.card1);
        addPhotoMapMarker(new GeoCoordinates(48.185798, 16.395408), R.drawable.card2);
        addPhotoMapMarker(new GeoCoordinates(48.185798, 16.405408), R.drawable.card3);
